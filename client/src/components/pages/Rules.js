            ...
            <div className="mx-16">
                ...
                <div class="flex flex-col space-y-4">
                    <div className="flex justify-center text-black font-serif">
                        ...
                        is started by whoever's turn is next. These rules are constant throughout
                    ...
                    <div className="flex justify-center text-black font-serif">
                        ...
                        until your hand has at least 3 cards. If you already have 3 or more cards,
                        you don't need to pick any cards. This continues until the drawpile is out
                        of cards, and now you no longer have to have 3 cards after your turn. Once
                    ...
                    <div className="flex justify-center text-black font-serif">
                        ...
                        side rule here: If one or more of these cards match the card you just put
                        down, you may play it as well. For example, if you just played a 3, and one
                        of your three cards that you pick up is also a 3, you may play that now as
                    ...
                    <div className="flex justify-center text-black font-serif">
                        ...
                        is empty again, you can pick up a second facedown card and add it to your
                        hand. The game progresses, and when you finally get a empty hand again, you
                        can pick up the last facedown card. If you now reach an empty hand, (meaning
                ...
                <ul class="list-disc text-black font-serif">
                    ...
                    <li>
                        7 is a wildcard that can be played on top of any card that acts like a
                        temporary skip. It then becomes the next player's turn, who has to play a
                        card that addresses the card under the 7. For example, a player can play a 7
                        on top of a King, even though the King is larger than the 7. The next player
                        will then have to play a card that can be played on top of the King, not the
                        7.
                    </li>
                    <li>
                        9 is the one card that breaks the rule of playing a card equal to or higher
                        than the previous card. When a 9 is played, the next player must play a card
                        lower than 9. If a 7 is played on top of a 9, the next player still has to
                        play a card lower than 9.
                    </li>
                    <li>
                        10 is a card that can be played on top of any card except the 9. The 10 is a
                        Bomb, meaning the current pile of cards is discarded, and the player who
                        played the 10 starts a new pile by playing any card they want.
                    </li>
                    <li>
                        Playing four of the same card (or eight if with 2 decks) also acts like a
                        bomb if they are legally played. For example, someone could play four 5s on
                        top of a 2 and that current pile would be discarded, but they could not play
                        the four 5s on top of a 6.
                    </li>
                </ul>
            </div>
        </div>
